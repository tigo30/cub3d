...
/*   Updated: 2025/03/02 19:48:56 by tgrunho-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_if_map_closed(t_map *map_file, const t_coord start,
	t_coord last_pos, t_coord pos)
{
	t_coord	neighbors[4];
	int		i;
...
void	validate_map_borders(t_map *map_file)
{
	...
	if (!check_if_map_closed(map_file, starting_point,
